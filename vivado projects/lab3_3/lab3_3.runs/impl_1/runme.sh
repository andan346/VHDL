...
HD_PWD='X:/Documents/VHDL/vivado projects/lab3_3/lab3_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comb_lock.tcl -notrace
