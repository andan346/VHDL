...
HD_PWD='X:/Documents/VHDL/vivado projects/lab3_3/lab3_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb_lock.tcl
