...
HD_PWD='X:/Documents/VHDL/vivado projects/datorlektion_d3/datorlektion_d3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kaskad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kaskad.tcl
