...
HD_PWD='X:/Documents/VHDL/vivado projects/datorlektion_d3/datorlektion_d3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kaskad.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kaskad.tcl -notrace
